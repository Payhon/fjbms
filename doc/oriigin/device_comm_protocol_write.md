...
| 4 | 电池类型 | H：电池类型；L：保留 | 2 | RW | / | / | / | `0x00` 默认保留；`0x01` 磷酸铁锂；`0x02` 锰酸锂；`0x03` 三元锂；`0x04` 钴酸锂；`0x05` 聚合锂；`0x06` 钛酸锂；`0x07` 铅酸；`0x08` 镍氢；`0x09` 钠离子 |
...
- `bit13`：放电加热功能
- `bit12`：低温加热功能
- `bit10`：充电允许，`0` 为允许，`1` 为禁止
- `bit9`：放电允许，`0` 为允许，`1` 为禁止
